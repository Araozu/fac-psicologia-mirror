...
export default function Admin() {
    ...
    const estandarList = {
        "8": {n: "EstandarSelector 8", titulo: "Estadar para la gestion de calidad"},
        "9": {n: "EstandarSelector 9", titulo: "Estadar para la gestion de calidad"},
        "10": {n: "EstandarSelector 10", titulo: "Estadar para la gestion de calidad"},
    }
