...
export default function Editar(props) {
    ...
    //Cargamos el PM de la base de datos y establecemos el loading en true
    ...
    const [modalInfo, setModalInfo] = useState({
        ...
        body: "Se edito con exito el plan de mejora"
    });

    //Realizamos la consulta cuando se carga la pagina
    useEffect( () => {
        const getPM = async () => {
        ...
        <>
            <form onSubmit={formik.handleSubmit}>
                <div className="div-title">
                    <label className="title">Formulario de edición de plan de mejora {pm.codigo}</label>
                </div>
