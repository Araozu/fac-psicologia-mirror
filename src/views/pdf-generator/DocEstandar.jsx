            ...
            <Page size="A4" style={styles.page} orientation="landscape">
              ...
              Oportunidad de mejora / Plan de mejora
                ...
                <View style={[styles.fila, {fontWeight: "normal"}]}>
                    ...
                    >
                        <Text style={{margin: 2}}>
                            {plan.problemas_oportunidades.map((el) => `- ${el.value}\n`)}
                        </Text>
                    </View>
                    <View
                        style={[
                    ...
                    >
                        <Text style={{margin: 2}}>
                            {plan.causas_raices.map((el) => `- ${el.value}\n`)}
                        </Text>
                    </View>
                    <View
                        style={[
                    ...
                    >
                        <Text style={{margin: 2}}>
                            {plan.acciones_mejoras.map((el) => `- ${el.value}\n`)}
                        </Text>
                    </View>
                    <View
                        style={[
                    ...
                    >
                        <Text style={{margin: 2}}>
                            {plan.responsables.map((el) => `- ${el.value}\n`)}
                        </Text>
                    </View>
                    <View
                        style={[
                    ...
                    >
                        <Text style={{margin: 2}}>
                            {plan.observaciones.map((el) => `- ${el.value}\n`)}
                        </Text>
                    </View>
                    <View style={[styles.celda, {width: "5%"}, styles.borderLB]}>
