        ...
        <>
            ...
            {!isHidden &&
                <div style={{
                    display: "block",
                    textAlign: "center",
                }} id="sidebar-link-content-suffix">
...
type SidebarProps = {
    setIsHiddenParent?: (v: (_: boolean) => void) => void,
    handleViewChange?: Function,
}
export default function Sidebar(props: SidebarProps) {
    const {setIsHiddenParent} = props;
    ...
    return (
        <>
            <nav
                className={`${navClasses} md:left-0 md:block md:top-0 md:bottom-0 md:overflow-y-auto md:overflow-hidden shadow bg-white flex flex-wrap items-center justify-between relative sidebar`}>
                ...
                <div className="w-full flex flex-col justify-start content-start">
                    <button
                        ...
                        <i className={`fa-solid fa-angles-right fa-lg ${hiddenButtonName}`}
                    ...
                    <div className="mt-10 mx-4">
                        ...
                        {isHidden ? <></> :
                            ...
                            >
                                ...
                                <h4 className="text-sm"><span style={{fontSize: "0.6em"}}>Escuela Profesional de</span>
                                    <br/> <strong> Relaciones Industriales</strong></h4>
                            </Link>}
                    ...
                    <ul className="flex flex-col list-none mx-4">
                        <SidebarLink path="/dashboard" text="Mis planes" prefixIcon="fa-solid fa-bookmark"
                    ...
                    {rol === "Admin" &&
                        <>
                            ...
                            <ul className="flex flex-col list-none mx-4">
                                <SidebarLink path="/admin/users/" text="Usuarios" prefixIcon="fa-solid fa-users"
                                             sufixIcon="fa-solid fa-angle-right" isHidden={isHidden} disabled={false}/>
                            </ul>
                    ...
                    {rol === "Admin" &&
                        <>
                            ...
                            <ul className="flex flex-col list-none mx-4">
                                <SidebarLink path="/admin/estandares" text="Estándares" prefixIcon="fa-solid fa-users"
                                             sufixIcon="fa-solid fa-angle-right" isHidden={isHidden} disabled={false}/>
                            </ul>
                    ...
                    <ul className="flex flex-col list-none mx-4">
                        ...
                        <SidebarLink path="/admin/estandar10" text="Pronto mas" prefixIcon="fa-solid fa-tv"
                                     sufixIcon="fa-solid fa-angle-right" isHidden={isHidden} disabled={true}/>
                    </ul>
                </div>
            </nav>
        </>
